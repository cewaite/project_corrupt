class_name PlayerV2 extends CharacterBody3D
...
# Temporary curr Gun slot, to be replaced by Inventory component later
...
func _physics_process(delta):
	...
	## Update Camera and Colliders depending on inputs ##
	_UpdateCamera(delta)
	_UpdateCollider()
